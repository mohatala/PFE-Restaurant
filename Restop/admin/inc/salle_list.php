            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-12 text-right">
                        <button class="btn btn-primary rounded-0" id="draw"> Draw to Map Salle</button>
                        <button class="btn btn-primary rounded-0 d-none" id="create_table"> Create Salle</button>
...
<script>
    ...
    function map_tbls(){
        if(Object.keys(tbl).length > 0){
            ...
            Object.keys(tbl).map(k=>{
                ...
                $('#fp-map').append(area)
                area.click(function(){
                    uni_modal('Table Details',"inc/view_salle.php?id="+data.id)
                })
            })
        }
    }
    $(function(){
        ...
        $('.edit_data').click(function(){
            uni_modal('Edit Salle Details',"inc/manage_salle.php?id="+$(this).attr('data-id'))
        })
        ...
        $('#create_table').click(function(){
            uni_modal("Map Table","inc/manage_salle.php?x="+px1_perc+"&y="+py1_perc+"&w="+px2_perc+"&h="+py2_perc)
        })
