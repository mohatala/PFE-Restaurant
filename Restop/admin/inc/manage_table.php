...
<form action="" id="table-form">
    ...
    <div class="form-group">
        <label for="tbl_no" class="control-label">Table Number</label>
        <input type="Number" name="tbl_no" id="tbl_no" required class="form-control form-control-sm rounded-0" value="<?php echo isset($tbl_no)? $tbl_no : '' ?>">
    </div>
    <div class="form-group">
