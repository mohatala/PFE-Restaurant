...
<head>
    ...
    <title>LOGIN | Administration Restop</title>
...
<body class="bg-warning bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">Restop - Admin</h3>
        <div class="card my-3 col-md-4 offset-md-4">
            <div class="card-body">
                <form action="" id="login-form">
                    <center><small>Entrer Vos Donnees.</small></center>
                    ...
                    <div class="form-group d-flex w-100 justify-content-between">
                        <a href="./../../">Allez au siteweb</a>
                        <button class="btn btn-sm btn-primary rounded-0 my-1">Se Connecter</button>
                    </div>
                </form>
            </div>
        </div>
