        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'reservation')? 'active' : '' ?>" href="./?page=reservation"><i class="fa fa-user-clock"></i> Reservation List</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'table_list')? 'active' : '' ?>" href="./?page=table_list"><i class="fa fa-th-list"></i> Table List</a>
                    </li>
                    <li class="nav-item">
